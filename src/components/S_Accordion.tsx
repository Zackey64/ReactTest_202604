...
// 1. Accordion（親）
export const S_Accordion = ({ children, className }: AccordionProps) => {
...
export const S_Summary = ({ children, className }: AccordionProps) => {
...
export const S_Details = ({ children, className }: AccordionProps) => {
